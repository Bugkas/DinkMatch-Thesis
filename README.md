...
All system architecture diagrams are located in the `docs/graphs-and-charts/` directory:

| Diagram Name | Asset Path | Description |
| :--- | :--- | :--- |
| **DFD Level 0 (Context)** | `docs/graphs-and-charts/pngs/01_DFD_lvl0.jpg` | Context diagram showing kiosk boundary and external entity interfaces. |
| **DFD Level 1** | `docs/graphs-and-charts/pngs/01_DFD_lvl1.png` | Decomposes the kiosk into 6 core processes and 4 local data stores. |
| **DFD Level 2 (Matchmaking)**| `docs/graphs-and-charts/pngs/01_DFD_lvl2 Process 2.0.png` | Deep-dive decomposition of the Matchmaking Optimization Solver (Process 2.0). |
| **DFD Level 2 (Video Fault)**| `docs/graphs-and-charts/pngs/01_DFD_lvl2 Process 7.0 .png` | Exception handling and telemetry workflows for hardware/video faults. |
| **Structured Chart** | `docs/graphs-and-charts/pngs/02_Structured_Chart.png` | High-level architectural partition of execution modules. |
| **HIPO VTOC Diagram** | `docs/graphs-and-charts/pngs/03_HIPO Diagram.png` | Visual Table of Contents mapping hierarchical functional components. |
| **Entity-Relationship (ERD)** | `docs/graphs-and-charts/pngs/06_ERD.png` | Database schemas and relation mappings for local and cloud data structures. |
